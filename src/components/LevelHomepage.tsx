...
const LevelHomepage: React.FC<LevelHomepageProps> = ({ 
  ...
  const getLevelIcon = () => {
    switch (currentRole.level) {
      case 'province': return <Building2 className="h-5 w-5 text-blue-600" />;
      case 'city': return <Users className="h-5 w-5 text-green-600" />;
      case 'county': return <MapPin className="h-5 w-5 text-orange-600" />;
      case 'substation': return <Zap className="h-5 w-5 text-purple-600" />;
      case 'grid': return <Activity className="h-5 w-5 text-red-600" />;
        ...
        <CardContent className="p-4 relative z-10">
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-lg font-bold">智能体</h2>
            ...
            <div className="text-right">
              ...
              <div className="text-xs text-blue-100">总体完成率</div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-2 mb-4">
            ...
            >
              ...
              <div className="text-xs text-blue-100 mt-1">管辖单位</div>
            </div>
            <div 
              className="text-center bg-white/15 backdrop-blur-sm rounded-lg p-3 cursor-pointer hover:bg-white/20 transition-colors"
            ...
            >
              ...
              <div className="text-xs text-blue-100 mt-1">总任务数</div>
            </div>
            <div 
              className="text-center bg-white/15 backdrop-blur-sm rounded-lg p-3 cursor-pointer hover:bg-white/20 transition-colors"
            ...
            >
              ...
              <div className="text-xs text-blue-100 mt-1">总数据量</div>
            </div>
            <div 
              className="text-center bg-white/15 backdrop-blur-sm rounded-lg p-3 cursor-pointer hover:bg-white/20 transition-colors"
              onClick={handleDataVolumeClick}
            >
              ...
              <div className="text-xs text-blue-100 mt-1">已处理量</div>
            </div>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-3 mb-4">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-sm font-semibold">AI智能功能</span>
              <Badge className="bg-green-500 text-xs px-1.5 py-0.5">运行中</Badge>
            </div>
          ...
          <div className="mb-3">
            <div className="flex justify-between items-center mb-2">
              <span className="text-xs text-blue-100">数据处理进度</span>
              <span className="text-xs font-medium">
                <AnimatedNumber value={dataVolumeStats.processingRate} suffix="%" />
              </span>
            </div>
            <Progress value={dataVolumeStats.processingRate} className="h-2 bg-white/20" />
          </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                {getLevelIcon()}
                <div>
                  <h2 className="text-lg font-bold">{currentRole.name}</h2>
                  <p className="text-xs opacity-90">{currentRole.level === 'city' ? '地市级管理中心' : '区县级管理中心'}</p>
                </div>
              </div>
              <Badge className="bg-white/20 text-white border-white/30 text-xs px-1.5 py-0.5">
            ...
            <div className="grid grid-cols-2 gap-2">
              <div 
                className="text-center bg-white/15 backdrop-blur-sm rounded-lg p-2 cursor-pointer hover:bg-white/20 transition-colors"
                onClick={handleUnitsClick}
              >
              ...
              <div className="text-center bg-white/15 backdrop-blur-sm rounded-lg p-2">
          ...
          <CardContent className="p-3">
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h3 className="text-sm font-bold">AI智能体</h3>
            ...
            <div className="grid grid-cols-2 gap-1.5 mb-2">
              <div 
                className="text-center bg-white/15 backdrop-blur-sm rounded-lg p-1.5 cursor-pointer hover:bg-white/25 transition-colors"
                onClick={() => handleAIFeatureClick('analysis')}
              >
                <BarChart3 className="h-3 w-3 mx-auto mb-1 text-cyan-200" />
                <div className="text-xs text-indigo-100">智能分析</div>
              </div>
              <div 
                className="text-center bg-white/15 backdrop-blur-sm rounded-lg p-1.5 cursor-pointer hover:bg-white/25 transition-colors"
                onClick={() => handleAIFeatureClick('task-assignment')}
              >
                <Target className="h-3 w-3 mx-auto mb-1 text-green-200" />
              ...
              <div 
                ...
                onClick={() => handleAIFeatureClick('quality-monitor')}
              >
                <Shield className="h-3 w-3 mx-auto mb-1 text-yellow-200" />
                <div className="text-xs text-indigo-100">质量监控</div>
              </div>
              <div 
                className="text-center bg-white/15 backdrop-blur-sm rounded-lg p-1.5 cursor-pointer hover:bg-white/25 transition-colors"
                onClick={() => handleAIFeatureClick('decision-support')}
              >
                <FileText className="h-3 w-3 mx-auto mb-1 text-purple-200" />
            ...
            <div className="mb-2">
              ...
              <Progress value={statistics.taskCompletion} className="h-1.5 bg-white/20" />
            </div>

            {/* 任务统计 */}
            <div className="grid grid-cols-2 gap-2">
              <div 
                className="text-center p-1.5 bg-green-50 rounded-lg cursor-pointer hover:bg-green-100 transition-colors"
                onClick={() => onTaskDetailClick?.('completed')}
              >
              ...
              <div 
                className="text-center p-1.5 bg-orange-50 rounded-lg cursor-pointer hover:bg-orange-100 transition-colors"
                onClick={() => onTaskDetailClick?.('pending')}
              >
